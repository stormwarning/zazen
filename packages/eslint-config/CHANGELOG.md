...
- Upgrade plugin dependencies ([#328](https://github.com/stormwarning/zazen/pull/328))

  - `@eslint/eslintrc` to 3.3.7
  - `@stylistic/eslint-plugin` to v5.10.0
  - `eslint-plugin-decorator-position` to 6.1.1
  - `eslint-plugin-import-x` to 4.17.1
  - `eslint-plugin-n` to 18.3.0
  - `eslint-plugin-perfectionist` to 5.11.0
  - `eslint-plugin-prefer-let` to 4.2.2
  - `eslint-plugin-promise` to 7.3.0
  - `globals` to 17.12.0
  - `typescript-eslint` to 8.70.0

- Change minimum supported ESLint version to v10 ([#295](https://github.com/stormwarning/zazen/pull/295))

## 7.5.0

### Minor Changes

- Upgrade plugin dependencies and change minimum Node version to 20.10.0. ([#280](https://github.com/stormwarning/zazen/pull/280))

  - `@eslint/eslintrc` to 3.3.3
  ...
  - `eslint-plugin-prefer-let` to 4.1.0
  - `eslint-plugin-unicorn` to 63.0.0
  - `globals` to 17.3.0
  - `typescript-eslint` to 8.56.0

- Add `props` to allowed abbreviations ([#278](https://github.com/stormwarning/zazen/pull/278))
- Add `globals` re-export ([#280](https://github.com/stormwarning/zazen/pull/280))
